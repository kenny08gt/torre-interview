<template>
    <h2 class="m-2 font-bold">Work Experience</h2>
    <perfect-scrollbar>
        <div >
            <div v-for="job in jobs" class="flex justify-between">
                <div class="year w-max" style="">
                    {{ job.fromYear }}<br>
                    <small>{{ job.toYear ? job.toYear : ''}}</small>
                </div>

                <ElementListing class="ml-0 relative">
